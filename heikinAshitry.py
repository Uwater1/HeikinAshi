...
def run(path):
    ...
    stats, heatmap, optimize_result = bt.optimize(
        atr_period=(8, 20),
        weight_bull_1=(20, 45),  # 0.25 to 0.35
        weight_bull_2=(15, 40),  # 0.15 to 0.25
        weight_bull_3=(20, 45),  # 0.30 to 0.40
        weight_bull_4=(25, 50),  # 0.40 to 0.50
        weight_bear_1=(10, 25),  # 0.15 to 0.25
        weight_bear_2=(5, 25),  # 0.10 to 0.20
        ...
        doji_threshold_bear=(10, 60),   # 0.2-0.6 bear quality threshold
        doji_lookback_bull=(4, 20),    # 10-25 (includes 15)
        ...
        weight_bear_momentum=(0, 90),   # 0.0-0.5 (0 = legacy mode)
